...
class SalesforceClient {
    ...
    login() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.conn.login(process.env.SALESFORCE_USERNAME, process.env.SALESFORCE_PASSWORD + process.env.SALESFORCE_SECURITY_TOKEN);
    ...
    query(queryString) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.conn.query(queryString);
            }
            catch (error) {
    ...
    create(objectType, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.conn.sobject(objectType).create(data);
